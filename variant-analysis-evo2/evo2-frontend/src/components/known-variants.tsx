...
export default function KnownVariants({
  ...
  const analyzeVariant = async (variant: ClinvarVariant) => {
    ...
    try {
      console.log("=== FRONTEND: Analyzing variant ===");
      console.log("Position:", variantDetails.position, typeof variantDetails.position);
      console.log("Alternative:", variantDetails.alternative, typeof variantDetails.alternative);
      console.log("Genome:", genomeId, typeof genomeId);
      console.log("Chromosome:", gene.chrom, typeof gene.chrom);
      console.log("===================================");
